...
public class SystemDataSeeder {
    ...
    public void seedDatabase() throws Exception {
        ...
        assignmentSubmissionRepository.save(AssignmentSubmission.builder()
                ...
                .trainerId(trainer1.getId())
                .batchId(batch1.getId())
                .submissionFileUrl("https://github.com/aarav/spt-assignment1")
                .submissionRemarks("Completed all endpoints and added unit tests.")
                .obtainedMarks(95)
                .status("EVALUATED")
        ...
        MonthlyAssessment assessment1 = monthlyAssessmentRepository.save(MonthlyAssessment.builder()
                ...
                .subject("Java & OOP")
                .description("Monthly evaluation covering Collections, Streams, Multithreading, and OOP concepts.")
                .batchId(batch1.getId())
                .trainerId(trainer1.getId())
                ...
                .lastSubmissionDate(LocalDate.now().plusDays(5))
                .status("PUBLISHED")
                .createdAt(LocalDateTime.now())
                .updatedAt(LocalDateTime.now())
                .build());
